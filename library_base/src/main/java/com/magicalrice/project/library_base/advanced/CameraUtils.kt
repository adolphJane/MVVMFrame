...
import com.magicalrice.project.library_base.base.ImageUtils
import java.io.File
...
object CameraUtils {
    ...
    fun getImagePickerIntent(
        outputX: Int, outputY: Int, fromFileURI: Uri,
        saveFileURI: Uri
    ): Intent {
     ...
     */
    fun getImagePickerIntent(
        aspectX: Int, aspectY: Int, outputX: Int, outputY: Int, fromFileURI: Uri,
        saveFileURI: Uri
    ): Intent {
     ...
     */
    fun getImagePickerIntent(
        aspectX: Int, aspectY: Int, outputX: Int, outputY: Int, canScale: Boolean,
        fromFileURI: Uri, saveFileURI: Uri
    ): Intent {
    ...
    fun getChoosedImagePath(context: Activity, data: Intent?): String? {
        ...
        return if (path.isEmpty()) originalUri.path else null
    }
    ...
    fun getTakePictureFile(data: Intent?, filePath: String): File? {
        ...
        return if (ImageUtils.save(photo, file, Bitmap.CompressFormat.JPEG)) file else null
    }
}
