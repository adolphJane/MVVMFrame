...
object LunarUtils {
     ...
     * @return 阴历
     */
    fun solar2Lunar(solar: Solar): Lunar {
        val lunar = Lunar()
    ...
    class Lunar {
        ...
        constructor(lunarYear: Int, lunarMonth: Int, lunarDay: Int, isLeap: Boolean) {
    ...
    class Solar {
        ...
        constructor(solarYear: Int = 0, solarMonth: Int = 0, solarDay: Int = 0) {
