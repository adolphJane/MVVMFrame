...
public final class NetworkUtils {
    ...
    public static void openWirelessSettings() {
        AppManageUtils.getApp().startActivity(
    ...
    public static boolean getWifiEnabled() {
        ...
        WifiManager manager = (WifiManager) AppManageUtils.getApp().getSystemService(WIFI_SERVICE);
    ...
    public static boolean isWifiConnected() {
        ConnectivityManager cm =
                (ConnectivityManager) AppManageUtils.getApp().getSystemService(Context.CONNECTIVITY_SERVICE);
    ...
    public static String getIpAddressByWifi() {
        @SuppressLint("WifiManagerLeak")
        WifiManager wm = (WifiManager) AppManageUtils.getApp().getSystemService(Context.WIFI_SERVICE);
        if (wm == null) return "";
