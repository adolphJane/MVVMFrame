...
import com.adolph.project.baseutils.constant.MemoryConstants;
import com.adolph.project.baseutils.constant.TimeConstants;
...
public final class ConvertUtils {
    ...
    public static Drawable bitmap2Drawable(final Bitmap bitmap) {
        return bitmap == null ? null : new BitmapDrawable(AppManageUtils.getApp().getResources(), bitmap);
    }
    ...
    public static int dp2px(final float dpValue) {
        final float scale = AppManageUtils.getApp().getResources().getDisplayMetrics().density;
    ...
    public static int sp2px(final float spValue) {
        final float fontScale = AppManageUtils.getApp().getResources().getDisplayMetrics().scaledDensity;
