...
public class AppSystemBarMgr {
    ...
    private static void invokePanels(final String methodName) {
        try {
            @SuppressLint("WrongConstant")
            Object service = AppManageUtils.getApp().getSystemService("statusbar");
    ...
    public static boolean isSupportNavBar() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1) {
            WindowManager wm = (WindowManager) AppManageUtils.getApp().getSystemService(Context.WINDOW_SERVICE);
        ...
        boolean menu = ViewConfiguration.get(AppManageUtils.getApp()).hasPermanentMenuKey();
