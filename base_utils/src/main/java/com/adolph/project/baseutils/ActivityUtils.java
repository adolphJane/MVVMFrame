...
public final class ActivityUtils {
    ...
    public static boolean isActivityExists(@NonNull final String pkg,
        ...
        return !(AppManageUtils.getApp().getPackageManager().resolveActivity(intent, 0) == null ||
                intent.resolveActivity(AppManageUtils.getApp().getPackageManager()) == null ||
                AppManageUtils.getApp().getPackageManager().queryIntentActivities(intent, 0).size() == 0);
    }
    ...
    public static void startActivity(@NonNull final Class<? extends Activity> clz) {
        Context context = AppManageUtils.getTopActivityOrApp();
    ...
    public static void startActivity(@NonNull final String pkg,
                                     @NonNull final String cls) {
        startActivity(AppManageUtils.getTopActivityOrApp(), null, pkg, cls, null);
    }
    ...
    public static void startActivity(@NonNull final String pkg,
                                     @NonNull final String cls,
                                     final Bundle options) {
        startActivity(AppManageUtils.getTopActivityOrApp(), null, pkg, cls, options);
    }
    ...
    public static void startActivity(@NonNull final Bundle extras,
                                     @NonNull final String pkg,
                                     @NonNull final String cls) {
        startActivity(AppManageUtils.getTopActivityOrApp(), extras, pkg, cls, null);
    }
    ...
    public static void startActivity(@NonNull final Bundle extras,
                                     ...
                                     @NonNull final String cls,
                                     final Bundle options) {
        startActivity(AppManageUtils.getTopActivityOrApp(), extras, pkg, cls, options);
    }
    ...
    public static boolean startActivity(@NonNull final Intent intent) {
        return startActivity(intent, AppManageUtils.getTopActivityOrApp(), null);
    }
    ...
    public static boolean startActivity(@NonNull final Intent intent,
                                        @NonNull final Bundle options) {
        return startActivity(intent, AppManageUtils.getTopActivityOrApp(), options);
    }
    ...
    public static void startActivities(@NonNull final Intent[] intents) {
        startActivities(intents, AppManageUtils.getTopActivityOrApp(), null);
    }
    ...
    public static void startActivities(@NonNull final Intent[] intents,
                                       final Bundle options) {
        startActivities(intents, AppManageUtils.getTopActivityOrApp(), options);
    }
    ...
    public static List<Activity> getActivityList() {
        return AppManageUtils.getActivityList();
    }
    ...
    public static String getLauncherActivity() {
        return getLauncherActivity(AppManageUtils.getApp().getPackageName());
    }
    ...
    public static Activity getTopActivity() {
        return AppManageUtils.getActivityLifecycle().getTopActivity();
    }
    ...
    public static boolean isActivityExistsInStack(@NonNull final Activity activity) {
        List<Activity> activities = AppManageUtils.getActivityList();
    ...
    public static Drawable getActivityIcon(@NonNull final Class<? extends Activity> clz) {
        return getActivityIcon(new ComponentName(AppManageUtils.getApp(), clz));
    }
    ...
    public static Drawable getActivityLogo(@NonNull final Class<? extends Activity> clz) {
        return getActivityLogo(new ComponentName(AppManageUtils.getApp(), clz));
    }
