...
public final class AppUtils {
    ...
    public static void registerAppStatusChangedListener(@NonNull final Object obj,
                                                        @NonNull final AppManageUtils.OnAppStatusChangedListener listener) {
        AppManageUtils.getActivityLifecycle().addOnAppStatusChangedListener(obj, listener);
    }
    ...
    public static void unregisterAppStatusChangedListener(@NonNull final Object obj) {
        AppManageUtils.getActivityLifecycle().removeOnAppStatusChangedListener(obj);
    }
    ...
    public static void installApp(final File file) {
        ...
        AppManageUtils.getApp().startActivity(getInstallAppIntent(file, true));
    }
    ...
    public static void uninstallApp(final String packageName) {
        ...
        AppManageUtils.getApp().startActivity(getUninstallAppIntent(packageName, true));
    }
    ...
    public static boolean isAppInstalled(@NonNull final String packageName) {
        PackageManager packageManager = AppManageUtils.getApp().getPackageManager();
        try {
    ...
    public static boolean isAppDebug() {
        return isAppDebug(AppManageUtils.getApp().getPackageName());
    }
    ...
    public static boolean isAppSystem() {
        return isAppSystem(AppManageUtils.getApp().getPackageName());
    }
    ...
    public static boolean isAppForeground() {
        return AppManageUtils.isAppForeground();
    }
    ...
    public static void launchApp(final String packageName) {
        if (isSpace(packageName)) return;
        AppManageUtils.getApp().startActivity(getLaunchAppIntent(packageName, true));
    }
    ...
    public static void relaunchApp(final boolean isKillProcess) {
        PackageManager packageManager = AppManageUtils.getApp().getPackageManager();
        Intent intent = packageManager.getLaunchIntentForPackage(AppManageUtils.getApp().getPackageName());
        if (intent == null) return;
        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        AppManageUtils.getApp().startActivity(intent);
    ...
    public static void launchAppDetailsSettings() {
        launchAppDetailsSettings(AppManageUtils.getApp().getPackageName());
    }
    ...
    public static void exitApp() {
        List<Activity> activityList = AppManageUtils.getActivityList();
    ...
    public static Drawable getAppIcon() {
        return getAppIcon(AppManageUtils.getApp().getPackageName());
    }
    ...
    public static String getAppPackageName() {
        return AppManageUtils.getApp().getPackageName();
    }
    ...
    public static String getAppName() {
        return getAppName(AppManageUtils.getApp().getPackageName());
    }
    ...
    public static String getAppPath() {
        return getAppPath(AppManageUtils.getApp().getPackageName());
    }
    ...
    public static String getAppVersionName() {
        return getAppVersionName(AppManageUtils.getApp().getPackageName());
    }
    ...
    public static int getAppVersionCode() {
        return getAppVersionCode(AppManageUtils.getApp().getPackageName());
    }
    ...
    public static Signature[] getAppSignature() {
        return getAppSignature(AppManageUtils.getApp().getPackageName());
    }
    ...
    public static String getAppSignatureSHA1() {
        return getAppSignatureSHA1(AppManageUtils.getApp().getPackageName());
    }
    ...
    public static String getAppSignatureSHA256() {
        return getAppSignatureSHA256(AppManageUtils.getApp().getPackageName());
    }
    ...
    public static String getAppSignatureMD5() {
        return getAppSignatureMD5(AppManageUtils.getApp().getPackageName());
    }
    ...
    public static AppInfo getAppInfo() {
        return getAppInfo(AppManageUtils.getApp().getPackageName());
    }
    ...
    private static Intent getInstallAppIntent(final File file, final boolean isNewTask) {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.N) {
            ...
            String authority = AppManageUtils.getApp().getPackageName() + ".utilcode.provider";
            data = FileProvider.getUriForFile(AppManageUtils.getApp(), authority, file);
        }
    ...
    private static Intent getLaunchAppIntent(final String packageName, final boolean isNewTask) {
        Intent intent = AppManageUtils.getApp().getPackageManager().getLaunchIntentForPackage(packageName);
    ...
    private static String getForegroundProcessName() {
        ActivityManager am =
                (ActivityManager) AppManageUtils.getApp().getSystemService(Context.ACTIVITY_SERVICE);
        ...
        if (Build.VERSION.SDK_INT > Build.VERSION_CODES.LOLLIPOP) {
            ...
            try {// Access to usage information.
                ApplicationInfo info =
                        pm.getApplicationInfo(AppManageUtils.getApp().getPackageName(), 0);
                AppOpsManager aom =
                        (AppOpsManager) AppManageUtils.getApp().getSystemService(Context.APP_OPS_SERVICE);
                //noinspection ConstantConditions
                ...
                UsageStatsManager usageStatsManager = (UsageStatsManager) AppManageUtils.getApp()
