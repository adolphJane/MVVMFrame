...
import com.adolph.project.advancedutils.receiver.Check;
import com.adolph.project.baseutils.FileIOUtils;
import com.adolph.project.baseutils.FileUtils;
...
public class CpuUtil {
    ...
    public static String printCpuInfo() {
        String info = FileIOUtils.getFileOutputString(CPU_INFO_PATH);
    ...
    public static long getCurrentFreqency() {
        try {
            return Long.parseLong(FileIOUtils.getFileOutputString(CPU_FREQ_CUR_PATH).trim());
        } catch (Exception e) {
            e.printStackTrace();
        }
        return 0;
