...
class EasyImageGetter:Html.ImageGetter {
    ...
    fun setPlaceHolder(placeHolder:Int): EasyImageGetter {
        this.placeHolder = AppManageUtils.getApp().applicationContext.resources.getDrawable(placeHolder)
        return this
    }
    ...
    fun setError(error:Int): EasyImageGetter {
        this.error = AppManageUtils.getApp().applicationContext.resources.getDrawable(error)
        return this
    }
